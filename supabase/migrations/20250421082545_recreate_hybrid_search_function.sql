-- Drop the potentially conflicting function definition(s)
-- Using the argument types identified from pg_proc query result
...
-- Recreate the function with the desired definition including default values
